<#-- This is modified version of alfresco/site-webscripts/org/alfresco/components/document-details/document-links.get.html.xml -->
<@markup id="css" >
   <#-- CSS Dependencies -->
...
<@markup id="js">
   <#-- JavaScript Dependencies -->
	<#-- ucm-document-links.js depends on document-links.js -->
   <@script src="${url.context}/res/components/document-details/ucm-document-links.js" group="document-details"/>
</@>
