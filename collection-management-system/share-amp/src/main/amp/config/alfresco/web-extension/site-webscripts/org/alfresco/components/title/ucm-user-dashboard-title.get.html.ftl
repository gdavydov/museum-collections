...
<#--
	Disable customise dasboard button for evryone, but system admin
	https://forums.alfresco.com/forum/end-user-discussions/alfresco-share/how-invisible-customize-dashboard-button-12152012-0451
-->	
      <#if user.isAdmin>
