...
(function()
{
    ...
    * @constructor
    */
   Alfresco.module.UCMAboutShare = function(containerId)
   {
      ...
      Alfresco.module.UCMAboutShare.superclass.constructor.call(this, "Alfresco.module.UCMAboutShare", containerId, ["container", "connection", "json"]);

      return this;
   };

   YAHOO.extend(Alfresco.module.UCMAboutShare, Alfresco.component.Base,
   {
      scrollpos: 0,
      ...
      show: function AS_show()
      {
         ...
         else
         {
            ...
            {
               url: Alfresco.constants.URL_SERVICECONTEXT + "modules/ucm-about-share",
               dataObj:
               {
                  htmlid: this.id
               },
               ...
               execScripts: true,
               failureMessage: "Could not load About UCM Share template"
            });
         }
      },
...
Alfresco.module.getUCMAboutShareInstance = function()
{
   var instanceId = "alfresco-UCMAboutShare-instance";
   return Alfresco.util.ComponentManager.get(instanceId) || new Alfresco.module.UCMAboutShare(instanceId);
};