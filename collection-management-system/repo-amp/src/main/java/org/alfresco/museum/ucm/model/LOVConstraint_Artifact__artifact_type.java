 ...
 */
public class LOVConstraint_Artifact__artifact_type extends UCMListOfValuesConstraints implements Serializable {
	private static Log logger = LogFactory.getLog(LOVConstraint_Artifact__artifact_type.class);

	private static final long serialVersionUID = 1;
	private static final String TYPE_NAME = "ucm:artifact";
	private static final String PROPERTY_NAME = "ucm:artifact_type";
